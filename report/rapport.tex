...
\begin{document}
	...
	The aim of this project is to encode an algorithm able to compute the mean energy at fixd temperature of a spin chain modelled by the XXZ model. This model is described by the following hamiltonian:
	\begin{figure}[!h]
		\centering
